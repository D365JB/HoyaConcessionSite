#!/usr/bin/env python3
"""Write a clean seed.mjs without unicode characters."""

content = r"""import mysql from "mysql2/promise";
...
with open("/home/ubuntu/hoyas-concession/server/seed_clean.mjs", "w", encoding="ascii") as f:
    f.write(content)
print("Written seed_clean.mjs")
